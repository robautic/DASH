  ...
  return (
    <main style={{ minHeight: '100vh', background: '#0d0f0e', color: '#f5f7f4', padding: '48px 24px' }}>
      <article style={{ maxWidth: 820, margin: '0 auto', lineHeight: 1.7 }}>
        ...
        <p>Usuários do Dash e Pipe podem solicitar a exclusão de dados pessoais e dados associados à sua conta, observadas as hipóteses de retenção previstas em lei.</p>

        <h2>Como solicitar</h2>
        <p>Envie uma solicitação pelo canal oficial de contato informado no site do Dash e Pipe. Informe o e-mail utilizado na conta e descreva que deseja a exclusão dos dados associados ao serviço.</p>
        ...
        <h2>Integrações</h2>
        <p>Desconectar uma integração impede novos acessos pelo Dash e Pipe. Dados mantidos diretamente por serviços de terceiros, como a Meta e o WhatsApp Business, devem ser tratados também conforme as políticas e ferramentas desses provedores.</p>
