  ...
  return (
    <main style={{ minHeight: '100vh', background: '#0d0f0e', color: '#f5f7f4', padding: '48px 24px' }}>
      <article style={{ maxWidth: 820, margin: '0 auto', lineHeight: 1.7 }}>
        ...
        <p>Esta Política de Privacidade explica como a Fluxolu trata informações necessárias para disponibilizar sua plataforma de organização de conversas, pipeline, indicadores e integrações com serviços de mensageria.</p>
        ...
        <p>Quando o usuário conecta serviços de terceiros, como soluções do WhatsApp Business fornecidas pela Meta, o tratamento também fica sujeito aos termos e políticas desses provedores. A Fluxolu utiliza apenas as autorizações necessárias para executar as funcionalidades solicitadas.</p>
        ...
        <p style={{ marginTop: 48, color: '#aeb5ac' }}>Para solicitações relacionadas à privacidade, utilize o canal de contato oficial informado no site da Fluxolu.</p>
      </article>
    </main>
  )
}
