  ...
  return (
    <main style={{ minHeight: '100vh', background: '#0d0f0e', color: '#f5f7f4', padding: '48px 24px' }}>
      <article style={{ maxWidth: 820, margin: '0 auto', lineHeight: 1.7 }}>
        ...
        <h2>1. Serviço</h2>
        <p>A Fluxolu é uma plataforma de organização operacional que reúne conversas, pipeline, indicadores e integrações autorizadas com serviços de mensageria.</p>
        ...
        <p>A plataforma deve ser utilizada de forma lícita e em conformidade com as regras dos serviços integrados. É proibido utilizar a Fluxolu para fraude, abuso, envio não autorizado de mensagens ou violação de direitos de terceiros.</p>
        ...
        <p style={{ marginTop: 48, color: '#aeb5ac' }}>Ao utilizar a Fluxolu, o usuário declara estar de acordo com estes Termos de Uso.</p>
      </article>
    </main>
  )
}
